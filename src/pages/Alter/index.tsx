...
export default function AlterPage() {
  ...
  return (
    <AppLayout>
      <Helmet>
        <title>Express Mei | Alteração de MEI</title>
        <meta
          name="description"
          content="Express MEI - Facilitando sua vida com confiança, praticidade e velocidade. Faça sua alteração de MEI agora mesmo de forma facilitada."
        />
      </Helmet>
      <OpenPageContainer>
        <div className="call">
          <h1 data-aos="fade-up">
            <span>Alteração</span> de MEI
          </h1>
          <p data-aos="fade-up">
            Seu CNPJ alterado chegará no e-mail informado em até 24 horas úteis após a
        ...
        <PaymentContainer onSubmit={onSubmit}>
          <div>
            ...
            <div className="cnpjData">
              ...
              <p>
                Informe os dados que deseja alterar, caso não deseje alterar um
                dado basta deixar o campo em branco
              </p>
              ...
              >
                <InputLabel id="secondary-cnpj-type">
                  Selecione as atividades secundárias do CNPJ
                </InputLabel>
                <Select
              ...
              />
              <span className="checkbox-title">Formas de atuação do CNPJ</span>
