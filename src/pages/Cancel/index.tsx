...
export default function CancelPage() {
  ...
  const productInfo = {
    ...
    name: "Cancelar MEI",
    amount: 14990,
    description: "Cancelamento de MEI",
    code: "156",
  };
  ...
  return (
    <AppLayout>
      <Helmet>
        <title>Express Mei | Cancelar MEI</title>
        <meta
          name="description"
          content="Express MEI - Facilitando sua vida com confiança, praticidade e velocidade ! Faça seu cancelamento de MEI agora mesmo de forma facilitada."
        />
      </Helmet>
      <OpenPageContainer>
        <div className="call">
          <h1 data-aos="fade-up">
            <span>Cancelamento</span> de MEI
          </h1>
          <p data-aos="fade-up">
            Seu comprovamente de cancelamento chegará no e-mail informado em até 24 horas úteis após a
