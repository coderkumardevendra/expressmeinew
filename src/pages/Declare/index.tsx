...
export default function DeclarePage() {
  ...
  const validationSchema = yup.object({
    ...
    // faturamento
    faturamentoVendaBruta: yup.string(),
    faturamentoPrestacaoServico: yup.string(),
    faturamentoTransportePassageiros: yup.string(),
    faturamentoTransporteCarga: yup.string(),
    faturamentoOutros: yup.string(),
    precisoDeAjuda: yup.boolean(),
  });
  ...
  const formik = useFormik({
    initialValues: {
      ...
      declaracaoDai: false,
      // faturamento
      faturamentoVendaBruta: "0",
      faturamentoPrestacaoServico: "0",
      faturamentoTransportePassageiros: "0",
      faturamentoTransporteCarga: "0",
      faturamentoOutros: "0",
      precisoDeAjuda: false,
    },
  ...
  return (
    <AppLayout>
      <Helmet>
        <title>Express Mei | Declaração de MEI</title>
        <meta
          name="description"
          content="Express MEI - Facilitando sua vida com confiança, praticidade e velocidade ! Faça sua declaração de MEI agora mesmo de forma facilitada."
        />
      </Helmet>
      <OpenPageContainer>
        <div className="call">
          <h1 data-aos="fade-up">
            <span>Declaração</span> de MEI
          </h1>
          <p data-aos="fade-up">
            Seu recibo de declaração chegará no e-mail informado em até 24 horas úteis após a
        ...
        <PaymentContainer onSubmit={onSubmit}>
          <div>
            ...
            <div className="faturamentoData">
              <h3>Dados Faturamento</h3>

              <NumericFormat
                className="input-mask"
                value={formik.values.faturamentoVendaBruta}
                displayType="input"
                thousandSeparator="."
                decimalSeparator=","
                prefix="R$ "
                ...
                onValueChange={(values) => {
                  formik.setFieldValue(
                    "faturamentoVendaBruta",
                    values.floatValue
                  );
                }}
                fullWidth
                id="faturamentoVendaBruta"
                name="faturamentoVendaBruta"
                variant="outlined"
                customInput={TextField}
                label={"Faturamento Bruto Anual de Venda de Produtos em R$"}
              />

              <NumericFormat
                className="input-mask"
                value={formik.values.faturamentoPrestacaoServico}
                displayType="input"
                thousandSeparator="."
                decimalSeparator=","
                prefix="R$ "
                ...
                onValueChange={(values) => {
                  formik.setFieldValue(
                    "faturamentoPrestacaoServico",
                    values.floatValue
                  );
                }}
                fullWidth
                id="faturamentoPrestacaoServico"
                name="faturamentoPrestacaoServico"
                variant="outlined"
                customInput={TextField}
                label={"Faturamento Bruto Anual de Prestação de Serviços em R$"}
              />

              <NumericFormat
                className="input-mask"
                value={formik.values.faturamentoTransportePassageiros}
                displayType="input"
                thousandSeparator="."
                decimalSeparator=","
                prefix="R$ "
                ...
                onValueChange={(values) => {
                  formik.setFieldValue(
                    "faturamentoTransportePassageiros",
                    values.floatValue
                  );
                }}
                fullWidth
                id="faturamentoTransportePassageiros"
                name="faturamentoTransportePassageiros"
                variant="outlined"
                customInput={TextField}
                label={
                  "Faturamento Bruto Anual de Transporte de Passageiros em R$"
                }
              />

              <NumericFormat
                className="input-mask"
                value={formik.values.faturamentoTransporteCarga}
                displayType="input"
                thousandSeparator="."
                decimalSeparator=","
                prefix="R$ "
                ...
                onValueChange={(values) => {
                  formik.setFieldValue(
                    "faturamentoTransporteCarga",
                    values.floatValue
                  );
                }}
                fullWidth
                id="faturamentoTransporteCarga"
                name="faturamentoTransporteCarga"
                variant="outlined"
                customInput={TextField}
                label={"Faturamento Bruto Anual de Transporte de Cargas em R$"}
              />

              <NumericFormat
                className="input-mask"
                value={formik.values.faturamentoOutros}
                displayType="input"
                thousandSeparator="."
                decimalSeparator=","
                prefix="R$ "
                allowNegative={false}
                onValueChange={(values) => {
                  formik.setFieldValue("faturamentoOutros", values.floatValue);
                }}
                fullWidth
                id="faturamentoOutros"
                name="faturamentoOutros"
                variant="outlined"
                customInput={TextField}
                label={"Despesas Anuais em R$"}
              />
              ...
              <label className="label-input">
                <input
                  type="checkbox"
                  name="precisoDeAjuda"
                  checked={formik.values.precisoDeAjuda}
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                />
                <div>
                  ...
                  >
                    Preciso de ajuda para preencher os dados de faturamento.
                  </p>
                </div>
              </label>
            </div>
